  ...
  public: {
    Tables: {
      charging_stations: {
        ...
        Relationships: [
          {
            foreignKeyName: "charging_stations_service_id_fkey"
            columns: ["service_id"]
            isOneToOne: false
      ...
      fuel_prices: {
        ...
        Relationships: [
          {
            foreignKeyName: "fuel_prices_service_id_fkey"
            columns: ["service_id"]
            isOneToOne: false
            referencedRelation: "services"
            referencedColumns: ["id"]
      ...
      user_preferences: {
        Row: {
          auto_navigation: boolean | null
          created_at: string
          fuel_alert_threshold: number | null
          id: string
          max_detour_km: number | null
          preferred_fuel_type: string | null
          preferred_payment_method: string | null
          privacy_share_location: boolean | null
          privacy_share_trips: boolean | null
          show_fuel_alerts: boolean | null
          show_traffic_alerts: boolean | null
          updated_at: string
          user_id: string | null
